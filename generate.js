...
\n`;
  ...
  output += `  /**\n`;
  output += `   * Get details for a Steam application using the Steam Store API.\n`;
  output += `   * \n`;
  output += `   * @param appid The Steam Application ID\n`;
  ...
  output += `   */\n`;
  output += `  getAppDetails(appid: number | string, code?: string, language?: string): Promise<SteamAppDetailsResponse>;\n\n`;
  output += `  /**\n`;
